...
public class ContaController {
	...
	@GetMapping("buscar")
	public ResponseEntity<ContaResponse> buscaPeloNumero(@RequestParam Long numeroConta){
		return new ResponseEntity<ContaResponse>(contaService.consultaContaPeloNumero(numeroConta), HttpStatus.OK);
	}
